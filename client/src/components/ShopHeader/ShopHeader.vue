<template>
  <div class="shop-header">
      ...
      <div class="header-content">
        <h2 class="content-title">
          <span class="content-tag">
            <span class="mini-tag">{{info.title}}</span>
          </span>
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">月销售{{info.sellCount}}单</span>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="activityShow">
